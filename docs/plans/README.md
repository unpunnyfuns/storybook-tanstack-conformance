...
| ----- | ----- | ---- | ---- | ------ |
| 0 | this repo | Instruments: gauge stories and e2e for the unmeasured findings (server-fn semantics, createStart, redirects, navigation seam) | [phase 0](2026-08-01-phase-0-instruments.md) | planned |
